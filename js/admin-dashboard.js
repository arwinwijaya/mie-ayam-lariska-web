/**
 * Admin Dashboard — Menu and Packages CRUD
 *
 * Full admin dashboard logic for managing menu items and packages.
 * Handles CRUD operations, drag-and-drop reordering, modals, and
...
function initDashboard() {
  ...
  // Position control
  var positionTypeSelect = document.getElementById('menu-position-type');
  var positionRefSelect = document.getElementById('menu-position-ref');

  positionTypeSelect.addEventListener('change', function() {
    var showRef = this.value === 'before' || this.value === 'after';
    positionRefSelect.style.display = showRef ? 'block' : 'none';
  ...
  document.getElementById('package-modal-close').addEventListener('click', closePackageModals);
  document.getElementById('package-modal-cancel').addEventListener('click', closePackageModals);
  document.getElementById('package-form').addEventListener('submit', handlePackageFormSubmit);
  document.getElementById('package-delete-modal-close').addEventListener('click', closePackageModals);
  document.getElementById('package-delete-cancel').addEventListener('click', closePackageModals);
  document.getElementById('package-delete-confirm').addEventListener('click', handlePackageDeleteConfirm);
