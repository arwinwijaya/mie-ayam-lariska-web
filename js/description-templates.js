 ...
 *
 * Architecture: ES Module, exposes DescriptionTemplates via export and window.DescriptionTemplates
 */
...
export { DescriptionTemplates, generateDescription, generateBulkDescriptions, getTemplatesForCategory, addTemplate, TEMPLATES, TOPPING_MAP };

// Backward compatibility: expose on window for non-module scripts
window.DescriptionTemplates = DescriptionTemplates;
